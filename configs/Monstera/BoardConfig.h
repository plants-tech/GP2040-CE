...
// Mapping between Monstera switch number (as silkscreened) and GPIO pin

#define MONSTERA_SW2_PIN    7
#define MONSTERA_SW3_PIN    6
#define MONSTERA_SW4_PIN    5
#define MONSTERA_SW5_PIN    4
#define MONSTERA_SW6_PIN    3
#define MONSTERA_SW7_PIN    2
#define MONSTERA_SW8_PIN    10  // LEFT
#define MONSTERA_SW9_PIN    11 // DOWN
#define MONSTERA_SW10_PIN   14 // RIGHT
#define MONSTERA_SW12_PIN   18 // P1 / SQUARE
#define MONSTERA_SW13_PIN   24 // P2 / TRIANGLE
#define MONSTERA_SW14_PIN   27 // P3
#define MONSTERA_SW15_PIN   29 // P4
#define MONSTERA_SW16_PIN   19 // K1 / CROSS
#define MONSTERA_SW17_PIN   23 // K2 / CIRCLE
#define MONSTERA_SW18_PIN   26 // K3
#define MONSTERA_SW19_PIN   28 // K4
#define MONSTERA_SW11_PIN   15 // UP / THUMB
...
#define PIN_DPAD_UP     MONSTERA_SW11_PIN         // DOWN
#define PIN_DPAD_DOWN   MONSTERA_SW9_PIN          // UP
#define PIN_DPAD_RIGHT  MONSTERA_SW10_PIN          // RIGHT
#define PIN_DPAD_LEFT   MONSTERA_SW8_PIN          // LEFT
#define PIN_BUTTON_B1   MONSTERA_SW16_PIN         // B1 / A / B / Cross / 2 / K1
#define PIN_BUTTON_B2   MONSTERA_SW17_PIN         // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_R2   MONSTERA_SW18_PIN         // R2 / RT / ZR / R2 / 8 / K3
#define PIN_BUTTON_L2   MONSTERA_SW19_PIN         // L2 / LT / ZL / L2 / 7 / K4
#define PIN_BUTTON_B3   MONSTERA_SW12_PIN         // B3 / X / Y / Square / 1 / P1
#define PIN_BUTTON_B4   MONSTERA_SW13_PIN         // B4 / Y / X / Triangle / 4 / P2
#define PIN_BUTTON_R1   MONSTERA_SW14_PIN         // R1 / RB / R / R1 / 6 / P3
#define PIN_BUTTON_L1   MONSTERA_SW15_PIN         // L1 / LB / L / L1 / 5 / P4
#define PIN_BUTTON_S1   MONSTERA_SW3_PIN          // S1 / Back / Minus / Select / 9 / Coin
#define PIN_BUTTON_S2   MONSTERA_SW2_PIN          // S2 / Start / Plus / Start / 10 / Start
#define PIN_BUTTON_L3   MONSTERA_SW6_PIN          // L3 / LS / LS / L3 / 11 / LS
#define PIN_BUTTON_R3   MONSTERA_SW7_PIN          // R3 / RS / RS / R3 / 12 / RS
#define PIN_BUTTON_A1   MONSTERA_SW4_PIN          // A1 / Guide / Home / PS / 13 / ~
#define PIN_BUTTON_A2   MONSTERA_SW5_PIN          // A2 / ~ / Capture / ~ / 14 / ~
